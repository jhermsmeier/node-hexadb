...
/**
 * Builds a query describing object from a triple pattern
 ...
 * @return {Object} query
 */
HexaDB.buildQuery = function( pattern, options ) {
  ...
  var query = {
    fillCache: true,
    offset: typeof options.offset === 'number' ? offset : 0,
...
HexaDB.prototype = {
  ...
  getStream: function( pattern, options ) {
    ...
    var stream = this.graph.createValueStream(
      HexaDB.buildQuery( pattern, options )
    )
