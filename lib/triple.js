...
Triple.prototype = {
  ...
  get isSparse() {
    ...
    var hasHoles = this.subject == null ||
      this.predicate == null ||
      this.object == null
    
    var hasVariables = this.subject instanceof Variable ||
      this.predicate instanceof Variable ||
      this.object instanceof Variable
